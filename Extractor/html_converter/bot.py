...
<a href="https://t.me/Theprimevault01" style="text-decoration: none; color: inherit;">
  <i class="fas fa-bolt"></i> The kmx <i class="fas fa-bolt"></i>
</a>
...
<a href="https://t.me/Theprimevault01" style="text-decoration: none; color: inherit;">
  <span class="badge bg-primary me-2">
    <i class="fas fa-robot"></i> Join @Theprimevault01
  </span>
</a>

            <a href="https://t.me/Theprimevault01" class="text-decoration-none">
    ...
    pdf_links = "".join(
        ...
        f'<button class="btn-action download" onclick="downloadFile(\'{obfuscate_url(url)}\', \'{name} - @thekmx.pdf\')" title="Download PDF">'
...
async def handle_txt2html(client: Client, message: Message):
    ...
    try:
        ...
        html_file_name = f"{base_name}_@Theprimevault01 .html"
